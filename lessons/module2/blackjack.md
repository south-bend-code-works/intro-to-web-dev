...
You have already creaetd a deck before if you have completed the [second practice problem for module 2](deck_of_cards.html). Using what you learned then, build (or copy/paste) your `buildDeck` function into your JS.
